		...
		<div>
			<div className="container">
				...
				<div className="about">
					...
					<div className="right">
					<img src={require("../../assets/images/istockphoto-1330071835-612x612.jpg")}/>
					</div>
				...
				<div className="mission">
					<div className="left">
					<img src={require("../../assets/images/img_60ee800e0eb9c.jpg")}/>
					</div>
					<div className="right">
...
Thank you for choosing 'carRent' for your car rental needs. We look forward to serving you and providing you with a memorable and enjoyable travel experience.</p>
				...
				<div className="team">
					...
					<div className="card">
						<div className="circle-container">
						<img src={require("../../assets/images/ayşenur.jpg")} className="profile"/>
						</div>
					...
					<div className="card">
						<div className="circle-container">
						<img src={require("../../assets/images/erman.jpg")} className="profile"/>
						</div>
